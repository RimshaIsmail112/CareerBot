...
const CandidateHeroSection = () => {
    ...
    return (
        <div className='pb-20 pt-14 px-10 md:px-12 relative'>
            <Image className={'absolute top-0 right-0 -z-10 hidden md:flex'} src={'/CandidateHeroSection.gif'} alt='Candidate Hero Section' width={400} height={400} />
            <h1 className='md:text-5xl leading-7 text-3xl text-center font-bold mb-7'>Get The <span className='text-[#504ED7]'>Right Job</span> <br className='hidden md:block' /> You Deserve</h1>
