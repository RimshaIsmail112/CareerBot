...
export default function ScheduleMeeting() {
      ...
      async function createMeeting() {
        try {
          const response = await fetch(
            `${HOST}/api/zoom/auth/callback?code=${code}`
          );
  ...
  return (
    <>
      ...
      <div className="max-w-md w-full h-auto flex flex-col justify-center items-center gap-2 mx-auto rounded-none md:rounded-2xl p-4">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56">
                    <DropdownMenuRadioGroup value={day} onValueChange={setDay}>
                      ...
                      <DropdownMenuRadioItem value="FRIDAY">
                        FRIDAY
                      </DropdownMenuRadioItem>
