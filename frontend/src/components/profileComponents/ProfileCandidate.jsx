...
function Modal({ onClose, onSave, type, children }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-slate-900 border-2 border-slate-700 p-5 rounded-3xl shadow-lg max-w-md w-full">
...
function ProfileDetailsForm() {
  ...
  return (
    <>
      ...
      <div className="bg-transparent shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full ">
    ...
    <span>Allow employers on the platform to view my profile</span>
          ...
          <div className="flex gap-4">
            <button
              ...
              className="bg-slate-900 border-2 border-slate-700 text-[1rem] w-full font-medium flex justify-center items-center gap-1 text-slate-50 rounded-md h-10 cursor-pointer transition-all duration-300 transform active:bg-slate-900 hover:bg-slate-900 hover:border-slate-50 hover:border-2 hover:text-slate-50"
            >
              + Add Work Experience
            </button>
          </div>
          ...
          {formData.workExperiences.map(
            (exp, index) =>
              isExperienceValid(exp) && (
                <div
                  key={index}
                  className="p-2 border rounded mt-2 text-slate-50 bg-slate-900 relative"
                >
                  <button
