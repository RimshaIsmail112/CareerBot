        ...
        <div className="space-y-4">
          <div className="flex flex-col justify-center items-center gap-5">
            ...
            <label
              ...
              className="bg-slate-900 text-[1rem] w-1/2 border-2 border-slate-50 font-medium flex justify-center items-center gap-1 text-slate-50 rounded-md h-10 cursor-pointer transition-all duration-300 transform active:bg-slate-900 hover:bg-slate-900 hover:border-slate-50 hover:border-2 hover:text-slate-50"
            >
          ...
          {/* Industry Input */}
          <LabelInputContainer className="mb-4">
            <Label htmlFor="industry" className="text-slate-50">
              Industry
            </Label>
            <Input
              id="industry"
          ...
          {/* Contact Input */}
          <LabelInputContainer className="mb-4">
            <Label htmlFor="contact" className="text-slate-50">
              Contact
            </Label>
            <Input
              id="contact"
          ...
          <LabelInputContainer className="mb-4">
            <Label htmlFor="companyDescription" className="text-slate-50">
              Company Description
            </Label>
            <Textarea
          ...
          {/* Website URL Input */}
          <LabelInputContainer className="mb-4">
            <Label htmlFor="websiteURL" className="text-slate-50">
              Website URL
            </Label>
            <div className="relative flex justify-center items-center">
              <Input
                ...
                type="url"
                className="text-slate-50 bg-slate-900 placeholder:text-slate-400 pl-8"
              />
              <span className="absolute inset-y-0 left-0 flex items-center justify-center pl-2">
                <MdInsertLink className="text-slate-50" />
              </span>
            </div>
          </LabelInputContainer>
          <LabelInputContainer className="mb-4">
            <Label htmlFor="facebookURL" className="text-slate-50">
              Facebook URL
            </Label>
            <div className="relative flex justify-center items-center">
              <Input
              ...
              />
              <span className="absolute inset-y-0 left-0 flex items-center justify-center pl-2">
                <ImFacebook2 className="text-slate-50" />
              </span>
            </div>
          </LabelInputContainer>
          <LabelInputContainer className="mb-4">
            <Label htmlFor="instagramURL" className="text-slate-50">
              Instagram URL
            </Label>
            <div className="relative flex justify-center items-center">
              <Input
              ...
              />
              <span className="absolute inset-y-0 left-0 flex items-center justify-center pl-2">
                <FaInstagramSquare className="text-slate-50" />
              </span>
            </div>
          </LabelInputContainer>
          {/* Twitter URL Input */}
          <LabelInputContainer className="mb-4">
            ...
            <div className="relative flex justify-center items-center">
              ...
              />
              <span className="absolute inset-y-0 left-0 flex items-center justify-center pl-2">
                <FaXTwitter className="text-slate-50" />
              </span>
            </div>
          </LabelInputContainer>
          {/* Submit Button */}
