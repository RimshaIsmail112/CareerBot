...
function ProfileDetailsForm() {
  const { candidateData } = useContext(AppContext); // Use useContext to access candidateData
  ...
  const [formData, setFormData] = useState({
    ...
    skills: candidateData.skills || [], // Initialize with skills from context, if available
    currentSkill: "",
    workExperiences: candidateData.workExperiences || [], // Initialize with work experiences from context
  ...
  >
    ...
    <p>
      <strong>
        {exp.title ? exp.title : " "} | {exp.companyName ? exp.companyName : " "}
      </strong>
    </p>
    <p>
  {exp.location ? exp.location : " "} |{" "}
  <span className="italic">{exp.duration !== undefined ? exp.duration : ""}</span>
</p>
