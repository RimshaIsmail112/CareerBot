...
import {MdInsertLink, MdOutlineAlternateEmail} from 'react-icons/md'; // Import the icon components
        ...
        <div className="space-y-4">
          ...
          <LabelInputContainer className="mb-4">
            ...
            <div className="relative flex justify-center items-center">
              ...
              <span className="absolute inset-y-0 left-0 flex items-center justify-center pl-2"><MdInsertLink
          ...
          <LabelInputContainer className="mb-4">
            ...
            <div className="relative flex justify-center items-center">
              <Input id="facebookURL"
                     ...
                     type="url" className='text-slate-50 bg-slate-900 placeholder:text-slate-400 pl-8'/>
              <span className="absolute inset-y-0 left-0 flex items-center justify-center pl-2"><ImFacebook2
                  className="text-slate-50"/></span>
            </div>
          </LabelInputContainer>
          <LabelInputContainer className="mb-4">
            ...
            <div className="relative flex justify-center items-center">
              <Input id="instagramURL"
                     ...
                     type="url" className='text-slate-50 bg-slate-900 placeholder:text-slate-400 pl-8'/>
              <span className="absolute inset-y-0 left-0 flex items-center justify-center pl-2"><FaInstagramSquare
                  className="text-slate-50"/></span>
            </div>
          </LabelInputContainer>
          {/* Twitter URL Input */}
          <LabelInputContainer className="mb-4">
            ...
            <div className="relative flex justify-center items-center">
              <Input id="twitterURL"
                     ...
                     type="url" className='text-slate-50 bg-slate-900 placeholder:text-slate-400 pl-8'/>
              <span className="absolute inset-y-0 left-0 flex items-center justify-center pl-2"><FaXTwitter
                  className="text-slate-50"/></span>
            </div>
          </LabelInputContainer>
          {/* Submit Button */}
